...
To update the default portfolio, edit the 'const' variable towards end of document
...
2. In the home directory for git bash, create the alias by adding the following line to your .bashrc:
        alias info='cd /c/Users/Bruker/desktop/projects/terminal_finance && python portfolio.py -portfolio'
...
def view_portfolio(portfolio:list):
    ...
    for ticker in portfolio:
        ...
        print(ticker + ' Daily change:' + '%.2f' % daily_return +'%'+' , 7-day change:' + '%.2f' % day_7_return +'%'+' , 30-day change:' + '%.2f' % day_30_return +'%')
